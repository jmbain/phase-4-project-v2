...
def run():
    ...
    students = [
        ...
        Student(first_name="Jo", last_name="Self", dob=7/12/2019, age=5, expected_grade_level="1st Grade", user=self123),
        Student(first_name="Jen", last_name="Dovetheworld", dob=3/20/2020, age=4, expected_grade_level="Kindergarten", user=dovetheworld123),
        Student(first_name="Jam", last_name="Berry", dob=9/1/2020, age=4, expected_grade_level="PreK", user=berry123),
        Student(first_name="Jelly", last_name="Berry", dob=9/1/2020, age=4, expected_grade_level="PreK", user=berry123)
